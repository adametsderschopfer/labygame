...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FMazePreferencesTest, "Laby.Menu.SensitivityPersistence", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
bool FMazePreferencesTest::RunTest(const FString& Parameters)
{
	const FString Path = FPaths::ConvertRelativePathToFull(FPaths::ProjectSavedDir() / TEXT("Automation/MazePreferencesTest.ini"));
